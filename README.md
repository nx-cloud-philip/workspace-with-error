...
[Click here to finish setting up your workspace!](https://staging.nx.app/connect/1rO0ocg9Gd)
...
```sh
npx nx serve workspace-with-error
```

To create a production bundle:

```sh
npx nx build workspace-with-error
```

To see all available targets to run for a project, run:

```sh
npx nx show project workspace-with-error
```
